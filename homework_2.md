...
Для того, чтобы отобразить журна изменений вместе с ветвями, необходимо ввести команду *git log --graph*. Команда выводит дерево коммитов.
...
### Способы изменения репозитория: *__коммит, пуш, клон, форк__*
...
**_для создания репозитория_** нужно нажать на + в правом верхнем углу сайта, выбрать пункт New Repository, заполнить название и описание, проставить нужные галочки и щёлкнуть на Create Repository;
для загрузки файлов нужно зайти в нужный репозиторий, щёлкнуть на *__Add file__* и выбрать **_Upload files_**.
